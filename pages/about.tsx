...
const About: StatelessComponent<any> = () => (
  <Layout>
      <Header />
      <div className="About">
            <p>This application is a simple side-project created to learn a bit more about <a href="https://github.com/zeit/next.js/">Next.js</a> and <a href="https://www.typescriptlang.org/">TypeScript</a>.</p>
